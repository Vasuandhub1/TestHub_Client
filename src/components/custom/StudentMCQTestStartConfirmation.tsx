...
function StudentMCQTestStartConfirmation() {
        ...
        <CardContent className='flex justify-center'>
          <Card className="w-[40rem] bg-gray-100 dark:bg-gray-900 shadow-lg rounded-2xl p-6 transition-all mt-4">
            ...
            <CardFooter className='gap-3 flex items-center'>
              ...
              />
              Check if read all the instructions carefully and want to start the test right now
            </CardFooter>
          </Card>
        </CardContent>
...
export default StudentMCQTestStartConfirmation;
